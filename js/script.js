...
function sortByPoints(element) {
  Array.from(element.querySelectorAll(".list-group-item")).sort((a, b) => {
    return parseInt(b.querySelector(".badge").textContent) - parseInt(a.querySelector(".badge").textContent)
  }).forEach(item => {
